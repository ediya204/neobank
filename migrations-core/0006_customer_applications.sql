...
-- Public registration records are stored separately from credentials and
-- settlement data. The linked customer remains pending until KYC review,
-- operations activation, password setup, and TOTP enrollment complete.
CREATE TABLE IF NOT EXISTS customer_applications (
  ...
  CHECK (
    ...
    (account_type = 'business'
      ...
      AND beneficial_owner_name IS NOT NULL
      AND beneficial_owner_ownership IS NOT NULL
