...
assert.match(worker, /customer_totp_required/);
assert.match(worker, /session\?\.user\?\.totp_enabled !== true/);
assert.match(worker, /key === 'targetAccount'/);
assert.match(worker, /account\.customerId !== customerId/);
